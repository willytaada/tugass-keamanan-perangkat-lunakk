<?php
  ...
  $data_user =query("SELECT user.username, user.email, tb_log.time_log FROM tb_log INNER JOIN user ON tb_log.id_user = user.id_user WHERE level = 'mahasiswa' OR level = 'dosen' OR level = 'staff'");
?>
