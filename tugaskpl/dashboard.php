          ...
          <div class="col-md-4">
            <div class="box">
              ...
              <div class="card-body"><center>
                  ...
                  <a href="daftarmaha.html" class="btn btn-primary">
        ...
        <div class="col-md-4">
            <div class="box">
              ...
              <div class="card-body"><center>
                  ...
                  <a href="daftaradmin.html" class="btn btn-primary">
            ...
            <div class="box">
              <div class="row">
                <div class="card-body"><center>
                  ...
                  <img class="img-fluid mb-3" src="img/kepuasan.png" alt="Card image cap" style="height: 85px; width: 85px;"> <br><br>
                  <a href="daftardos.html" class="btn btn-primary">
                  <i class="fa fa-sign-in"></i> Kunjungi Halaman</a></center>
                </div>
              </div>
            </div>
