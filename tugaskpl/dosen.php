  ...
  <div class="wrapper">
      <nav class="navbar navbar-default">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Selamat Datang Dosen!</a>
        </div>
      </nav>
      <aside class="sidebar">
        <menu>
          <ul class="menu-content">
            <li><a href="dosen.html"><i class="fa fa-home"></i>Dashboard</a></li>
            <li><a href="dafmaha.html"><span>Daftar Mahasiswa</span></a></li>
          ...
          <div class="col-md-4">
            <div class="box">
              ...
              <div class="card-body"><center>
                  ...
                  <a href="dosen.html" class="btn btn-primary">
        ...
        <div class="col-md-4">
            <div class="box">
              ...
              <div class="card-body"><center>
                  ...
                  <a href="dafmaha.html" class="btn btn-primary">
